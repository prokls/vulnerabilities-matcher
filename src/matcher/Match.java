...
public class Match {
	...
	/**
	 * Retrieve some data about this vulnerability.
	 * Return the value corresponding to `key`.
	 * Uses the XML SAX parser for data retrieval.
	 * 
	 * @param vul_db_filepath  Filepath to vulnerability database (xml)
	 * @param key  An attribute of the vulnerability (eg. summary)
	...
	public String retrieve(String vul_db_filepath, String cve, String key) {
		...
		// TODO: return value corresponding to `key` for the given vulnerability `cve`
		return "TODO";
	}
